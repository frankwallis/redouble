  ...
  () => {
    describe(
      ...
      () => {
        ...
        test(
          "sets the cards for partial hand",
          () => {
            let board = Board.fromPBN("N:2.2.. ..3.3 4.4.. ..5.5");
            let south = Card.SeatMap.find(Seat.South, board.hands);
            expect(south)
            |> toEqual([(Card.Pip.Four, Card.Suit.Spades), (Card.Pip.Four, Card.Suit.Hearts)])
          }
        )
      }
    );
    describe(
      ...
      () => {
        ...
        test(
          "filters cards which have been played",
          () => {
            let pbn = "W:AKQJT98765432... .AKQJT98765432.. ..AKQJT98765432. ...AKQJT98765432";
            let board =
              Board.fromPBN(pbn)
            ...
            expect(Board.toPBN(board))
            |> toEqual("W:KQJT98765432... .KQJT98765432.. ..KQJT98765432. ...KQJT98765432")
          }
        )
      }
    )
